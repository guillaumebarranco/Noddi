	...
	<div class="content">
		<article class="offer">
			...
			<footer>
				...
				<div class="apply_offer button reversed" data-offer="<?=$offer->id?>" data-fromwho="modeuse" data-modeuse="<?=$this->request->session()->read('modeuse_id')?>">Utiliser mon boost</div>
			</footer>
		</article>
	</div>
