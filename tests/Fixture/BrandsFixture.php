...
class BrandsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'offers_created' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => '0', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'type_commerce' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'activity_id' => 1,
            'offers_created' => 1,
            'type_commerce' => 'Lorem ipsum dolor sit amet',
